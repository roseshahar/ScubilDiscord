...
def define_cmd(client, message, args):
    ...
    ***----***
    ...
    if all(c in english for c in args):
        # english
        url = 'http://api.wordnik.com:80/v4/word.json/%s/definitions?' \
              'limit=200&includeRelated=true&sourceDictionaries=all&' \
              'useCanonical=false&includeTags=false&api_key=a2a73e7b926c924fad7001ca3111acd55af2ffabf50eb4ae5' % args
